...
For each retailer: not just "42/90 SKUs would pass Walmart" but "the 48 that wouldn't represent $X in current Walmart revenue exposed to disruption."
...
Explicitly scope what's out of bounds: product images/rich media, EDI transaction data, distributor-specific portal requirements beyond the four retailers, Amazon-specific data, food service channel data. Signals judgment about scope boundaries.
