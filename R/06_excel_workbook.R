...
"missing_case_dims",           "TRUE if any of the three case dimension fields (length, width, height) are blank. Case weight is tracked separately in missing_case_weight.",
"weight_plausible",            "TRUE if case weight is within 20% of expected (unit weight x case pack quantity). FALSE if outside that range. NA if any input is missing.",
"oneworldsync_status",         "OneWorldSync registration status. Values: \"Registered - Complete\", \"Registered - Incomplete\", \"Not Registered\".",
"data_quality_score",          "Composite score from 0 to 100. Calculated as (checks passed / 8) x 100. The 8 checks: GTIN-14 valid, UPC-12 valid, case weight present, case dimensions present, country of origin present, brand owner present, OneWorldSync complete, case weight plausible.",
...
"chargeback_total",            "Total chargeback dollars over the 36-month observation window.",
"chargeback_count",            "Total number of chargeback events over the 36-month observation window.",
...
"chargeback_total",            "Total chargeback dollars, 36-month window.",
