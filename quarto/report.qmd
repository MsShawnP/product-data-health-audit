...
![Revenue at risk by retailer.](../output/charts/06_retailer_readiness_revenue_at_risk.png){fig-alt="Horizontal bar chart of TTM revenue at risk per contracted retailer, with Walmart leading at $18.2M."}
...
![Chargeback dollars by reason.](../output/charts/14_chargeback_by_reason.png){fig-alt="Horizontal bar chart breaking down chargeback dollars by reason, with three data-defect reasons (Invalid GTIN/UPC, Dimension mismatch, Missing product data) accounting for 96% of dollars."}
...
![Chargeback Pareto: a small number of SKUs drive most of the cost.](../output/charts/01_chargeback_pareto.png){fig-alt="Pareto curve showing 5 SKUs account for 50% of chargeback dollars and 15 SKUs account for 80%."}
...
![Process debt by data-entry source.](../output/charts/17_process_debt_by_updated_by.png){fig-alt="Bar chart of chargebacks-per-SKU by data entry source, showing four sources clustered around $1,400 and two materially better sources (production_admin, ops_coordinator)."}
